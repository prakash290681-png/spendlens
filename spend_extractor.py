...
# ============================================================
    ...
    if merchant == "Swiggy":
        ...
        # Step 1: Look for strong payment indicators
        match = re.search(
            r"(to\s*pay|total\s*payable|grand\s*total|amount\s*paid)"
            r"[^\d₹]{0,80}₹\s*([\d,]+(?:\.\d{1,2})?)",
            clean_body,
            re.IGNORECASE
        )
        ...
        # Step 2: fallback scan but ignore misleading rows
